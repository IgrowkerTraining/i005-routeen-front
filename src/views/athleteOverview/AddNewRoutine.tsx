            ...
            <div className="w-full sm:max-w-lg sm:bg-notwhite-400 sm:rounded-xl sm:shadow-lg sm:p-8">
                <main className="flex flex-col pb-2 gap-6 sm:px-0">
                    <div className="flex flex-col justify-center items-center gap-2 w-full">
                        ...
                        <span className="font-bold text-notblack-400">Rutinas disponibles</span>
                    </div>

                    <p className="flex flex-col pb-2 gap-6 sm:px-0">
                    ...
                    <button
                        className={`mt-4 px-4 py-2 rounded ${selectedRoutine
